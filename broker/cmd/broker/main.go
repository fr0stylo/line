...
func main() {
	...
	flag.Int64Var(&segmentSize, "segment-size", 64*1024*1024, "segment file size in bytes (default 64MB)")
...
func init() {
	flag.Usage = func() {
		...
		fmt.Fprintln(os.Stderr, "Line Broker - A durable message queue server")
		fmt.Fprintln(os.Stderr, "\nOptions:")
		flag.PrintDefaults()
		fmt.Fprintln(os.Stderr, "\nExamples:")
		fmt.Fprintln(os.Stderr, "  broker                          # Start with defaults (persistent, :50051)")
		fmt.Fprintln(os.Stderr, "  broker -addr :9090              # Custom port")
		fmt.Fprintln(os.Stderr, "  broker -memory                  # In-memory mode")
		fmt.Fprintln(os.Stderr, "  broker -data-dir /var/lib/line  # Custom data directory")
	}
}
